...
assert(function() for _, value in ipairs(task1.Subtasks) do if (value == task2) then return true end end return false end)
...
task2:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect1", sb_htn.Effects.EEffectType.PlanOnly,
    function(context1, type1) context1:SetState(TestContext.TestEnum.StateA, true, type1) end, TestContext))
local task3 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task3.Name = "Sub-task2"
task3:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect2", sb_htn.Effects.EEffectType.PlanAndExecute,
    function(context2, type2) context2:SetState(TestContext.TestEnum.StateB, true, type2) end, TestContext))
local task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task3"
task4:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect3", sb_htn.Effects.EEffectType.Permanent,
    function(context3, type3) context3:SetState(TestContext.TestEnum.StateC, true, type3) end, TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
...
task2.Name = "Sub-task1"
task2:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect1", sb_htn.Effects.EEffectType.PlanOnly,
    function(context4, type4) context4:SetState(TestContext.TestEnum.StateA, true, type4) end, TestContext))
task3 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task3.Name = "Sub-task2"
task3:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect2", sb_htn.Effects.EEffectType.PlanAndExecute,
    function(context5, type5) context5:SetState(TestContext.TestEnum.StateB, true, type5) end, TestContext))
task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task3"
task4:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect3", sb_htn.Effects.EEffectType.Permanent,
    function(context6, type6) context6:SetState(TestContext.TestEnum.StateC, true, type6) end, TestContext))
local task5 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task5.Name = "Sub-task4"
task5:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",

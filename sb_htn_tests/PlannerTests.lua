...
planner = sb_htn.Planners.Planner:new(TestContext)
if (pcall(function() planner:Tick(nil, nil) end)) then
...
ctx = TestContext:new()
local domain = sb_htn.Domain:new("Test", TestContext)
planner = sb_htn.Planners.Planner:new(TestContext)
...
ctx = TestContext:new()
ctx:init()
domain = sb_htn.Domain:new("Test", TestContext)
planner = sb_htn.Planners.Planner:new(TestContext)
...
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(nil, nil, TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context1) return sb_htn.Tasks.ETaskStatus.Success end, nil,
    TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context2) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context3) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task3:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
...
task3:SetOperator(sb_htn.Operators.FuncOperator:new(function(context4) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
task4:SetOperator(sb_htn.Operators.FuncOperator:new(function(context5) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context6) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task3.Name = "Sub-task1"
task3:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
    function(context19) return context19.Done == false end, TestContext))
task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task2"
task3:SetOperator(sb_htn.Operators.FuncOperator:new(function(context7) return sb_htn.Tasks.ETaskStatus.Success end, nil,
    TestContext))
...
task3:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.PlanAndExecute,
    function(context23, type) context23.Done = true end, TestContext))
task4:SetOperator(sb_htn.Operators.FuncOperator:new(function(context8) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(domain.Root, task2)
domain.AddTask(task1, task3)
...
task3.Name = "Sub-task1"
task3:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
    function(context20) return context20.Done == false end, TestContext))
task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task2"
task3:SetOperator(sb_htn.Operators.FuncOperator:new(function(context9) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
task4:SetOperator(sb_htn.Operators.FuncOperator:new(function(context10) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(domain.Root, task2)
domain.AddTask(task1, task3)
...
task3.Name = "Sub-task1"
task3:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
    function(context21) return context21.Done == false end, TestContext))
task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task2"
task3:SetOperator(sb_htn.Operators.FuncOperator:new(function(context11) return sb_htn.Tasks.ETaskStatus.Success end, nil
    , TestContext))
task4:SetOperator(sb_htn.Operators.FuncOperator:new(function(context12) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(domain.Root, task2)
domain.AddTask(task1, task3)
...
task3.Name = "Sub-task1"
task3:AddCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
    function(context22) return not context22:HasState(TestContext.TestEnum.StateA) end, TestContext))
task4 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task4.Name = "Sub-task2"
task3:SetOperator(sb_htn.Operators.FuncOperator:new(function(context13) return sb_htn.Tasks.ETaskStatus.Success end, nil
    , TestContext))
task3:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.PlanAndExecute,
    function(context24, type) context24:SetState(TestContext.TestEnum.StateA, true, type) end, TestContext))
task4:SetOperator(sb_htn.Operators.FuncOperator:new(function(context14) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(domain.Root, task2)
domain.AddTask(task1, task3)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context15) return sb_htn.Tasks.ETaskStatus.Failure end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context16) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
...
task2 = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
task2.Name = "Sub-task"
task2:SetOperator(sb_htn.Operators.FuncOperator:new(function(context17) return sb_htn.Tasks.ETaskStatus.Continue end, nil
    , TestContext))
task2:AddExecutingCondition(sb_htn.Conditions.FuncCondition:new("TestCondition",
    function(context25) return context25.Done end, TestContext))
domain.AddTask(domain.Root, task1)
domain.AddTask(task1, task2)
planner:Tick(domain, ctx)
assert(test)
...
actionA:AddCondition(sb_htn.Conditions.FuncCondition:new("Can choose A",
    function(context26) return context26.Done == true end, TestContext));
actionA:AddExecutingCondition(sb_htn.Conditions.FuncCondition:new("Can choose A",
    function(context27) return context27.Done == true end, TestContext));
...
actionB:AddCondition(sb_htn.Conditions.FuncCondition:new("Can not choose A",
    function(context28) return context28.Done == false end, TestContext));
actionB:AddExecutingCondition(sb_htn.Conditions.FuncCondition:new("Can not choose A",
    function(context29) return context29.Done == false end, TestContext));
...
actionA.Name = "Test Action A";
actionA:AddCondition(sb_htn.Conditions.FuncCondition:new("Can choose A",
    function(context30) return context30:GetState(TestContext.TestEnum.StateA) == 1 end, TestContext))
actionA:SetOperator(TestOperator:new());
actionB = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
actionB.Name = "Test Action B";
actionB:AddCondition(sb_htn.Conditions.FuncCondition:new("Can not choose A",
    function(context31) return context31:GetState(TestContext.TestEnum.StateA) == 0 end, TestContext))
actionB:SetOperator(TestOperator:new());
domain.AddTask(domain.Root, select);
domain.AddTask(select, actionA);
domain.AddTask(select, actionB);
...
actionA.Name = "Test Action A";
actionA:AddCondition(sb_htn.Conditions.FuncCondition:new("Can choose A",
    function(context32) return context32:GetState(TestContext.TestEnum.StateA) == 0 end, TestContext))
actionA:AddExecutingCondition(sb_htn.Conditions.FuncCondition:new("Can choose A",
    function(context33) return context33:GetState(TestContext.TestEnum.StateA) == 0 end, TestContext))
actionA:SetOperator(TestOperator:new());
actionB = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
actionB.Name = "Test Action B";
actionB:AddCondition(sb_htn.Conditions.FuncCondition:new("Can not choose A",
    function(context34) return context34:GetState(TestContext.TestEnum.StateA) == 1 end, TestContext))
actionB:AddExecutingCondition(sb_htn.Conditions.FuncCondition:new("Can not choose A",
    function(context35) return context35:GetState(TestContext.TestEnum.StateA) == 1 end, TestContext))
actionB:SetOperator(TestOperator:new());
domain.AddTask(domain.Root, select);
domain.AddTask(select, actionA);
domain.AddTask(select, actionB);

...
task3:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task1"
    p:AddCondition(sb_htn.Conditions.FuncCondition:new("Done == true", function(context) return context.Done == true end
        , TestContext))
    return p
end)());
task3:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
...
task:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task1"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context2, type) context2:SetState(TestContext.TestEnum.StateA, false,
...
task3:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task3"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context3, type) context3:SetState(TestContext.TestEnum.StateA, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
...
task2:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task4"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context4, type) context4:SetState(TestContext.TestEnum.StateB, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
task:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task1"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context5, type) context5:SetState(TestContext.TestEnum.StateA, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)());
...
task:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task5"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context6, type) context6:SetState(TestContext.TestEnum.StateC, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
...
task3:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task3"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context7, type) context7:SetState(TestContext.TestEnum.StateA, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
...
task2:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task4"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context8, type) context8:SetState(TestContext.TestEnum.StateB, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
task:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task1"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context9, type) context9:SetState(TestContext.TestEnum.StateA, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)());
...
task:AddSubtask((function() local p = sb_htn.Tasks.PrimitiveTasks.PrimitiveTask:new()
    p.Name = "Sub-task5"
    p:AddEffect(sb_htn.Effects.ActionEffect:new("TestEffect", sb_htn.Effects.EEffectType.Permanent,
        function(context10, type) context10:SetState(TestContext.TestEnum.StateC, false,
                sb_htn.Effects.EEffectType.PlanOnly)
        end, TestContext))
    return p
end)())
